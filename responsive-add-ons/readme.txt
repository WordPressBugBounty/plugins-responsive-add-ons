...
= 3.5.1 - 4th June 2026 =
* Enhancement - Added more blocks to the Elementor editor import feature.
...
= 3.4.8 - 23rd April 2026 =
* Fix - Fixed an issue where existing users were not able to view their activations on app.cyberchimps.com after connecting via Responsive Plus Dashboard

= 3.4.7 - 2nd April 2026 =
...
* Fix – Starter template library header position made sticky.
...
* Fix : Fixed templates inside elementor page not getting imported issue.
